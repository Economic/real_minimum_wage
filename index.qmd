...
### After the longest period in history without an increase, the federal minimum wage today is worth `r decline_since_last` less than 15 years ago--and `r decline_since_peak` less than in 1968 
