...
plots
```
All values in `r format(yearmonth(current_cpi_date), format = "%B %Y")` dollars, adjusted using the CPI-U in 2022 chained to the CPI-U-RS (1978–2021) and CPI-U-X1 (1967–1977) and CPI-U (1966 and before). For the exact calculations, see <https://github.com/Economic/real_minimum_wage>